...
from PyQt5.QtWidgets import QApplication, QMessageBox, QPushButton, QDialog, QFileDialog, QLineEdit, QGridLayout, QLabel
    ...
    def DownloadData(self, extras):
        try:
            ...
            if type(NoOfTerms) == type(int()):
                ...
                QMessageBox.warning(self, "Error", "Please enter integer number in \'Number of Tweets\' field, please check your internet connection or your Tweeter Keys...".format(QMessageBox.warning))
        except:
            QMessageBox.warning(self, "Error", "Some error has occurred, please check your internet connection or your Twitter Keys...".format(QMessageBox.warning))
